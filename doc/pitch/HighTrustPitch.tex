...
\newcommand{\wordcount}{
    ...
    \IfFileExists{count.txt}{(\input{count.txt}words)}{}}
...
For USDOD customers, this product could be a key element for reliable cooperation in fifth generation warfare (5GW), or informational war -- wherein distinguishing friend from foe is increasingly difficult.
