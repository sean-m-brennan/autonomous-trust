...
class Tree(object):
    ...
    def to_nx_graph(self):
        """
        For use with networkx Graphs
        :return: nx.Graph
        """
        return nx_tree.from_nested_tuple(self.to_tuple())
    ...
    @classmethod
    def from_nx_graph(cls, graph, groot=0):
        """
        For use with networkx Graphs
        :param graph: nx.Graph
        :param groot: key of root of graph
        :return: Tree
        """
        nested_tpl = nx_tree.to_nested_tuple(graph, groot)
        return cls.from_tuple(nested_tpl)
