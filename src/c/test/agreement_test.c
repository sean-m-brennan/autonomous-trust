...
DEFINE_TEST(test_work_voting)
{
    ...
    /* first DIFFICULTY raw bytes should be 0x00 — canonical AT v1 POW
     * digest format on both Python (raw blake2b via _raw_hash) and C
     * (crypto_generichash_blake2b). See BUGS.md §P5 closure. */
