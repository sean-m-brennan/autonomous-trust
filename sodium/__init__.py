...
sodium_init = _sodium.sodium_init
...
try:
    ...
    HAS_SEAL = False
try:
    crypto_aead_aes256gcm_KEYBYTES = _sodium.crypto_aead_aes256gcm_keybytes()
    crypto_aead_aes256gcm_NPUBBYTES = _sodium.crypto_aead_aes256gcm_npubbytes()
    crypto_aead_aes256gcm_ABYTES = _sodium.crypto_aead_aes256gcm_abytes()
    HAS_AEAD_AES256GCM = bool(_sodium.crypto_aead_aes256gcm_is_available())
    crypto_aead_chacha20poly1305_ietf_KEYBYTES = _sodium.crypto_aead_chacha20poly1305_ietf_keybytes()
    crypto_aead_chacha20poly1305_ietf_NPUBBYTES = _sodium.crypto_aead_chacha20poly1305_ietf_npubbytes()
    crypto_aead_chacha20poly1305_ietf_ABYTES = _sodium.crypto_aead_chacha20poly1305_ietf_abytes()
...
crypto_box_SECRETKEYBYTES = _sodium.crypto_box_secretkeybytes()
crypto_box_SEEDBYTES = _sodium.crypto_box_seedbytes()
crypto_box_PUBLICKEYBYTES = _sodium.crypto_box_publickeybytes()
crypto_box_NONCEBYTES = _sodium.crypto_box_noncebytes()
crypto_box_ZEROBYTES = _sodium.crypto_box_zerobytes()
crypto_box_BOXZEROBYTES = _sodium.crypto_box_boxzerobytes()
crypto_box_BEFORENMBYTES = _sodium.crypto_box_beforenmbytes()
crypto_scalarmult_BYTES = _sodium.crypto_scalarmult_bytes()
crypto_scalarmult_SCALARBYTES = _sodium.crypto_scalarmult_scalarbytes()
crypto_sign_BYTES = _sodium.crypto_sign_bytes()
crypto_sign_SEEDBYTES = _sodium.crypto_sign_secretkeybytes() // 2
crypto_sign_PUBLICKEYBYTES = _sodium.crypto_sign_publickeybytes()
crypto_sign_SECRETKEYBYTES = _sodium.crypto_sign_secretkeybytes()
crypto_sign_ed25519_PUBLICKEYBYTES = _sodium.crypto_sign_ed25519_publickeybytes()
crypto_sign_ed25519_SECRETKEYBYTES = _sodium.crypto_sign_ed25519_secretkeybytes()
...
crypto_stream_KEYBYTES = _sodium.crypto_stream_keybytes()
crypto_stream_NONCEBYTES = _sodium.crypto_stream_noncebytes()
crypto_auth_BYTES = _sodium.crypto_auth_bytes()
crypto_auth_KEYBYTES = _sodium.crypto_auth_keybytes()
crypto_onetimeauth_BYTES = _sodium.crypto_onetimeauth_bytes()
crypto_onetimeauth_KEYBYTES = _sodium.crypto_onetimeauth_keybytes()
crypto_generichash_BYTES = _sodium.crypto_generichash_bytes()
crypto_generichash_BYTES_MIN = _sodium.crypto_generichash_bytes_min()
crypto_generichash_BYTES_MAX = _sodium.crypto_generichash_bytes_max()
crypto_generichash_KEYBYTES = _sodium.crypto_generichash_keybytes()
crypto_generichash_KEYBYTES_MIN = _sodium.crypto_generichash_keybytes_min()
crypto_generichash_KEYBYTES_MAX = _sodium.crypto_generichash_keybytes_max()
crypto_scalarmult_curve25519_BYTES = _sodium.crypto_scalarmult_curve25519_bytes()
crypto_hash_BYTES = _sodium.crypto_hash_sha512_bytes()
crypto_hash_sha256_BYTES = _sodium.crypto_hash_sha256_bytes()
crypto_hash_sha512_BYTES = _sodium.crypto_hash_sha512_bytes()
crypto_verify_16_BYTES = _sodium.crypto_verify_16_bytes()
crypto_verify_32_BYTES = _sodium.crypto_verify_32_bytes()
crypto_verify_64_BYTES = _sodium.crypto_verify_64_bytes()

try:
    randombytes_SEEDBYTES = _sodium.randombytes_seedbytes()
    HAS_RAND_SEED = True
except AttributeError:
    HAS_RAND_SEED = False

try:
    crypto_kdf_PRIMITIVE = _sodium.crypto_kdf_primitive()
    crypto_kdf_BYTES_MIN = _sodium.crypto_kdf_bytes_min()
    crypto_kdf_BYTES_MAX = _sodium.crypto_kdf_bytes_max()
    crypto_kdf_CONTEXTBYTES = _sodium.crypto_kdf_contextbytes()
    crypto_kdf_KEYBYTES = _sodium.crypto_kdf_keybytes()
    HAS_CRYPT_KDF = True
except AttributeError:
    HAS_CRYPT_KDF = False

try:
    crypto_kx_PUBLICKEYBYTES = _sodium.crypto_kx_publickeybytes()
    crypto_kx_SECRETKEYBYTES = _sodium.crypto_kx_secretkeybytes()
    crypto_kx_SEEDBYTES = _sodium.crypto_kx_seedbytes()
    crypto_kx_SESSIONKEYBYTES = _sodium.crypto_kx_sessionkeybytes()
    crypto_kx_PRIMITIVE = _sodium.crypto_kx_primitive()
    HAS_CRYPT_KX = True
except AttributeError:
    HAS_CRYPT_KX = False
...
def crypto_box_keypair():
    ...
    pk, sk = _sodium.crypto_box_keypair()
    '''
...
def crypto_box_seed_keypair(seed):
    ...
    pk = ctypes.create_string_buffer(crypto_box_PUBLICKEYBYTES)
    sk = ctypes.create_string_buffer(crypto_box_SECRETKEYBYTES)
    _sodium.crypto_box_seed_keypair(pk, sk, seed)
    return pk.raw, sk.raw
...
def crypto_scalarmult_base(sk):
    ...
    pk = ctypes.create_string_buffer(crypto_box_PUBLICKEYBYTES)
    if _sodium.crypto_scalarmult_base(pk, sk):
...
def crypto_box(msg, nonce, pk, sk):
    ...
    enc_msg = _sodium.crypto_box('secret message', <unique nonce>, <public key string>, <secret key string>)
    '''
    ...
    ret = _sodium.crypto_box(c, pad, ctypes.c_ulonglong(len(pad)), nonce, pk, sk)
    if ret:
...
def crypto_box_easy(msg, nonce, pk, sk):
    ...
    enc_msg = _sodium.crypto_box_easy('secret message', <unique nonce>, <public key string>, <secret key string>)
    '''
    if len(pk) != crypto_box_PUBLICKEYBYTES:
        raise ValueError('Invalid public key')
    if len(sk) != crypto_box_SECRETKEYBYTES:
    ...
    ret = _sodium.crypto_box(c, msg, ctypes.c_ulonglong(len(msg)), nonce, pk, sk)
    if ret:
        raise CryptError('Unable to encrypt message')
    return c.raw
...
def crypto_box_beforenm(pk, sk):
    ...
    ret = _sodium.crypto_box_beforenm(k, pk, sk)
    if ret:
...
def crypto_box_afternm(msg, nonce, k):
    ...
    ret = _sodium.crypto_box_afternm(ctxt, pad, ctypes.c_ulonglong(len(pad)), nonce, k)
    if ret:
...
def crypto_box_open_afternm(ctxt, nonce, k):
    ...
    pad = b'\x00' * crypto_box_BOXZEROBYTES + ctxt
    msg = ctypes.create_string_buffer(len(pad))
    ret = _sodium.crypto_box_open_afternm(
        msg,
        pad,
        ctypes.c_ulonglong(len(pad)),
        nonce,
...
def crypto_box_easy_afternm(msg, nonce, k):
    ...
    enc_msg = _sodium.crypto_box_easy_afternm('secret message', <unique nonce>, <shared key string>)
    '''
    if len(k) != crypto_box_BEFORENMBYTES:
        raise ValueError('Invalid shared key')
    if len(nonce) != crypto_box_NONCEBYTES:
    ...
    ret = _sodium.crypto_box_easy_afternm(ctxt, msg, ctypes.c_ulonglong(len(msg)), nonce, k)
    if ret:
        raise CryptError('Unable to encrypt messsage')
    return ctxt.raw
...
def crypto_box_open_easy_afternm(ctxt, nonce, k):
    ...
    if len(nonce) != crypto_box_NONCEBYTES:
        raise ValueError('Invalid nonce')
    msg = ctypes.create_string_buffer(len(ctxt) - crypto_box_MACBYTES)
    ret = _sodium.crypto_box_open_easy_afternm(
        msg,
        ctxt,
        ctypes.c_ulonglong(len(ctxt)),
        nonce,
...
def crypto_box_seal(msg, pk):
    ...
    enc_msg = _sodium.crypto_box_seal('secret message', <public key string>)
    '''
    if not HAS_SEAL:
    ...
    ret = _sodium.crypto_box_seal(c, msg, ctypes.c_ulonglong(len(msg)), pk)
    if ret:
        raise CryptError('Unable to encrypt message')
    return c.raw
...
def crypto_box_seal_open(ctxt, pk, sk):
    ...
    ret = _sodium.crypto_box_seal_open(c, ctxt, ctypes.c_ulonglong(len(ctxt)), pk, sk)
    if ret:
        raise CryptError('Unable to decrypt message')
    return c.raw
...
def crypto_sign_keypair():
    ...
    ret = _sodium.crypto_sign_keypair(vk, sk)
    if ret:
...
def crypto_sign_ed25519_keypair():
    ...
    ret = _sodium.crypto_sign_ed25519_keypair(vk, sk)
    if ret:
        raise ValueError('Failed to generate keypair')
    return vk.raw, sk.raw
...
def crypto_sign_ed25519_sk_to_pk(sk):
    ...
    ret = _sodium.crypto_sign_ed25519_sk_to_pk(pk, sk)
    if ret:
...
def crypto_sign_ed25519_sk_to_seed(sk):
    ...
    ret = _sodium.crypto_sign_ed25519_sk_to_seed(seed, sk)
    if ret:
...
def crypto_sign_detached(msg, sk):
    ...
    slen = ctypes.pointer(ctypes.c_ulonglong())
    ret = _sodium.crypto_sign_detached(
        sig,
        slen,
        msg,
        ctypes.c_ulonglong(len(msg)),
...
def crypto_sign_seed_keypair(seed):
    ...
    ret = _sodium.crypto_sign_seed_keypair(vk, sk, seed)
    if ret:
...
def crypto_sign_verify_detached(sig, msg, vk):
    ...
    ret = _sodium.crypto_sign_verify_detached(
        sig,
        msg,
        ctypes.c_ulonglong(len(msg)),
        vk)
...
def crypto_secretbox_open(ctxt, nonce, key):
    ...
    msg = ctypes.create_string_buffer(len(pad))
    ret = _sodium.crypto_secretbox_open(
        msg,
        pad,
        ctypes.c_ulonglong(len(pad)),
        nonce,
...
def crypto_secretbox_easy(cmessage, nonce, key):
    ...
    ret = _sodium.crypto_secretbox_easy(ctxt, cmessage, ctypes.c_ulonglong(len(cmessage)), nonce, key)
    if ret:
        raise ValueError('Failed to encrypt message')
    return ctxt.raw[0:]
...
def crypto_secretbox_open_easy(ctxt, nonce, key):
    ...
    ret = _sodium.crypto_secretbox_open_easy(msg, ctxt, ctypes.c_ulonglong(len(ctxt)), nonce, key)
    if ret:
        raise ValueError('Failed to decrypt message')
...
def crypto_aead_aes256gcm_encrypt(message, aad, nonce, key):
    ...
    ret = _sodium.crypto_aead_aes256gcm_encrypt(
...
def crypto_aead_chacha20poly1305_ietf_encrypt(message, aad, nonce, key):
    ...
    clen = ctypes.c_ulonglong()
    c = ctypes.create_string_buffer(length)
    ret = _sodium.crypto_aead_chacha20poly1305_ietf_encrypt(
        c, ctypes.pointer(clen),
        message, ctypes.c_ulonglong(len(message)),
        aad, ctypes.c_ulonglong(len(aad)),
        None,
...
def crypto_aead_aes256gcm_decrypt(ctxt, aad, nonce, key):
    ...
    ret = _sodium.crypto_aead_aes256gcm_decrypt(
        m, ctypes.byref(mlen),
        None,
...
def crypto_aead_chacha20poly1305_ietf_decrypt(ctxt, aad, nonce, key):
    ...
    ret = _sodium.crypto_aead_chacha20poly1305_ietf_decrypt(
        m, ctypes.byref(mlen),
        None,
        ctxt, ctypes.c_ulonglong(len(ctxt)),
        aad, ctypes.c_ulonglong(len(aad)),
...
def crypto_stream(slen, nonce, key):
    ...
    ret = _sodium.crypto_stream(stream, ctypes.c_ulonglong(slen), nonce, key)
    if ret:
...
def crypto_auth(msg, key):
    ...
    ret = _sodium.crypto_auth(tok, msg, ctypes.c_ulonglong(len(msg)), key)
    if ret:
...
def crypto_auth_verify(tok, msg, key):
    ...
    ret = _sodium.crypto_auth_verify(tok, msg, ctypes.c_ulonglong(len(msg)), key)
    if ret:
        raise ValueError('Failed to auth msg')
    return msg
...
def crypto_onetimeauth_primitive():
    ...
    Returns:
        str: always ``poly1305``
    """
    func = _sodium.crypto_onetimeauth_primitive
...
def crypto_onetimeauth_verify(token, message, key):
    ...
    ret = _sodium.crypto_onetimeauth_verify(
...
def crypto_hash(msg):
    ...
    _sodium.crypto_hash(hbuf, msg, ctypes.c_ulonglong(len(msg)))
    return hbuf.raw
...
def crypto_hash_sha256(msg):
    ...
    _sodium.crypto_hash_sha256(hbuf, msg, ctypes.c_ulonglong(len(msg)))
    return hbuf.raw
...
def crypto_hash_sha512(msg):
    ...
    _sodium.crypto_hash_sha512(hbuf, msg, ctypes.c_ulonglong(len(msg)))
    return hbuf.raw
...
def crypto_verify_16(string1, string2):
    ...
    timing attacks.
    '''
    a, b, c = (len(string1) >= 16), (len(string2) >= 16), (not _sodium.crypto_verify_16(string1, string2))
    return a & b & c
...
def crypto_verify_32(string1, string2):
    ...
    timing attacks.
    '''
    a, b, c = (len(string1) >= 32), (len(string2) >= 32), (not _sodium.crypto_verify_32(string1, string2))
    return a & b & c
...
def crypto_verify_64(string1, string2):
    ...
    timing attacks.
    '''
    a, b, c = (len(string1) >= 64), (len(string2) >= 64), (not _sodium.crypto_verify_64(string1, string2))
    return a & b & c
...
def bytes_eq(a, b):
    ...
    return _sodium.sodium_memcmp(a, b, len_a) == 0
...
def randombytes(size):
    ...
    _sodium.randombytes(buf, ctypes.c_ulonglong(size))
    return buf.raw
...
def randombytes_buf(size):
    ...
    size = int(size)
    buf = ctypes.create_string_buffer(size)
    _sodium.randombytes_buf(buf, size)
    return buf.raw
...
def randombytes_random():
    ...
    '''
    return _sodium.randombytes_random()
...
def randombytes_uniform(upper_bound):
    ...
    '''
    return _sodium.randombytes_uniform(upper_bound)
...
def crypto_kdf_derive_from_key(subkey_size, subkey_id, context, master_key):
    ...
    buf = ctypes.create_string_buffer(size)
    _sodium.crypto_kdf_derive_from_key(buf, subkey_size, ctypes.c_ulonglong(subkey_id), context, master_key)
    return buf.raw
...
def crypto_kx_seed_keypair(seed):
    ...
    pk = ctypes.create_string_buffer(crypto_kx_PUBLICKEYBYTES)
    sk = ctypes.create_string_buffer(crypto_kx_SECRETKEYBYTES)
    _sodium.crypto_kx_seed_keypair(pk, sk, seed)
    return pk.raw, sk.raw
...
def crypto_kx_client_session_keys(client_pk, client_sk, server_pk):
    ...
    status = _sodium.crypto_kx_client_session_keys(rx, tx, client_pk, client_sk, server_pk)
...
def crypto_kx_server_session_keys(server_pk, server_sk, client_pk):
    ...
    rx = ctypes.create_string_buffer(crypto_kx_SESSIONKEYBYTES)
    tx = ctypes.create_string_buffer(crypto_kx_SESSIONKEYBYTES)
    status = _sodium.crypto_kx_server_session_keys(rx, tx, server_pk, server_sk, client_pk)
    return rx.raw, tx.raw, status
...
def sodium_library_version_major():
    ...
    '''
    return _sodium.sodium_library_version_major()
...
def sodium_library_version_minor():
    ...
    '''
    return _sodium.sodium_library_version_minor()
...
def sodium_version_string():
    ...
    '''
    func = _sodium.sodium_version_string
    func.restype = ctypes.c_char_p
    return func()
...
def crypto_sign_ed25519_pk_to_curve25519(ed25519_pk):
    ...
    ret = _sodium.crypto_sign_ed25519_pk_to_curve25519(curve25519_pk, ed25519_pk)
    if ret:
...
def crypto_sign_ed25519_sk_to_curve25519(ed25519_sk):
    ...
    ret = _sodium.crypto_sign_ed25519_sk_to_curve25519(curve25519_sk, ed25519_sk)
    if ret:
