...
Usage (Docker or host):
    python -m autonomous_trust.simulator.instrumented [AT args] --metrics-output /path/to/metrics.json

Environment variable alternative:
    METRICS_OUTPUT=/path/to/metrics.json python -m autonomous_trust.simulator.instrumented [AT args]
"""
